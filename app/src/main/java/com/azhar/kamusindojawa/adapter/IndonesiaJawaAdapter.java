...
public class IndonesiaJawaAdapter extends RecyclerView.Adapter<IndonesiaJawaAdapter.IndonesiaJawaHolder> {

    Context ctx;
    ArrayList<ModelKamus> modelKamusArrayList;

    public IndonesiaJawaAdapter(Context context, ArrayList<ModelKamus> modelKamus) {
        this.ctx = context;
    ...
    @NonNull
    @Override
    public IndonesiaJawaAdapter.IndonesiaJawaHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_data, parent, false);
        return new IndonesiaJawaHolder(view);
    }

    @Override
    public void onBindViewHolder(IndonesiaJawaAdapter.IndonesiaJawaHolder holder, final int position) {
    ...
    static class IndonesiaJawaHolder extends RecyclerView.ViewHolder {
        public MaterialCardView cvListData;
        public TextView tvListData;

        public IndonesiaJawaHolder(View itemView) {
            super(itemView);
